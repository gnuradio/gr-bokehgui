...
export class WaterfallRendererView extends RendererView {
  ...
  protected _paint(): void {
    ...
    const sw = Math.floor(this.xscale.compute(this.model.fmax) - this.xscale.compute(this.model.fmin))
    const sh = Math.floor(this.yscale.compute(this.tile_height) - this.yscale.compute(0))
