...
class top_block(gr.top_block):
    def __init__(self, doc):
        ...
        # Blocks
        ##################################################
        self.bokehgui_waterfall_sink_c_proc_0 = bokehgui.waterfall_sink_c_proc(1024, firdes.WIN_BLACKMAN_hARRIS, 0, samp_rate/2, "Waterfall Sink")
        self.bokehgui_waterfall_sink_c_0 = bokehgui.waterfall_sink_c(self.doc, self.plot_lst, self.bokehgui_waterfall_sink_c_proc_0)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 000, 3, 0)
        ...
        ##################################################
        self.bokehgui_waterfall_sink_c_0.initialize(legend_list = ['Signal (5000 Hz)',
                                                                  ],
                                                    update_time = 100
                                                    )
        ...
        self.connect((self.blocks_throttle_0, 0), (self.bokehgui_waterfall_sink_c_proc_0, 0))
